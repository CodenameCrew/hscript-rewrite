...
{
	( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->cancelled = false;
	( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->run = run;
	( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->nextRunTime = nextRunTime;
	( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->interval = interval;
}
