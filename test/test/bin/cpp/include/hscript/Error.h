...
class HXCPP_CLASS_ATTRIBUTES Error_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::hscript::ErrorDef e, ::Dynamic min, ::Dynamic max,::String fileName, ::Dynamic line);
		...
		static ::hx::ObjectPtr< Error_obj > __new( ::hscript::ErrorDef e, ::Dynamic min, ::Dynamic max,::String fileName, ::Dynamic line);
		static ::hx::ObjectPtr< Error_obj > __alloc(::hx::Ctx *_hx_ctx, ::hscript::ErrorDef e, ::Dynamic min, ::Dynamic max,::String fileName, ::Dynamic line);
