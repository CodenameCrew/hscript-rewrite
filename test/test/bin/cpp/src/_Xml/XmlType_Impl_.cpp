...
::String XmlType_Impl__obj::toString(int this1){
	switch((int)(this1)){
		case (int)0: {
			return HX_("Element",9c,d6,a5,d3);
		}
		break;
		case (int)1: {
			return HX_("PCData",bd,3d,a2,bd);
		}
		break;
		case (int)2: {
			return HX_("CData",0d,60,15,c1);
		}
		break;
		case (int)3: {
			return HX_("Comment",3f,a2,c1,4e);
		}
		break;
		case (int)4: {
			return HX_("DocType",32,25,de,a5);
		}
		break;
		case (int)5: {
			return HX_("ProcessingInstruction",db,1e,14,6a);
		}
		break;
		case (int)6: {
			return HX_("Document",3b,ab,c4,74);
		}
		break;
	}
	return null();
