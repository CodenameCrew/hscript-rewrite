...
int FileInput_obj::readByte(){
	...
	try {
		...
		return _hx_std_file_read_char(this->_hx___f);
	} catch( ::Dynamic _hx_e) {
		if (_hx_e.IsClass<  ::Dynamic >() ){
			 ...
			 ::Dynamic _g = _hx_e;
			{
			 ...
			 ::Dynamic e = _g;
			if (( (bool)(e->__IsArray()) )) {
				HX_STACK_DO_THROW( ::haxe::io::Eof_obj::__alloc( HX_CTX ));
			}
			else {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	...
	try {
		HX_STACK_CATCHABLE( ::Dynamic, 0);
		return _hx_std_file_read(this->_hx___f,s->b,p,l);
	} catch( ::Dynamic _hx_e) {
		if (_hx_e.IsClass<  ::Dynamic >() ){
			HX_STACK_BEGIN_CATCH
			 ::Dynamic _g = _hx_e;
...
void FileInput_obj::close(){
	this->super::close();
	_hx_std_file_close(this->_hx___f);
}


void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
	int _hx_tmp;
	if (::hx::IsPointerEq( pos,::sys::io::FileSeek_obj::SeekBegin_dyn() )) {
		_hx_tmp = 0;
	}
	else {
		if (::hx::IsPointerEq( pos,::sys::io::FileSeek_obj::SeekCur_dyn() )) {
			_hx_tmp = 1;
		}
		else {
			_hx_tmp = 2;
	...
	_hx_std_file_seek(this->_hx___f,p,_hx_tmp);
}
...
int FileInput_obj::tell(){
	return _hx_std_file_tell(this->_hx___f);
}
...
bool FileInput_obj::eof(){
	return _hx_std_file_eof(this->_hx___f);
}
