...
void Timer_obj::__construct(int time_ms){
	...
	HX_END_LOCAL_FUNC0((void))
	 ...
	 ::haxe::Timer _gthis = ::hx::ObjectPtr<OBJ_>(this);
	this->thread = ::sys::thread::_Thread::HaxeThread_obj::current();
	this->eventHandler = ::sys::thread::_Thread::Thread_Impl__obj::get_events(this->thread)->repeat( ::Dynamic(new _hx_Closure_0(_gthis)),time_ms);
}
...
void Timer_obj::stop(){
	::sys::thread::_Thread::Thread_Impl__obj::get_events(this->thread)->cancel(this->eventHandler);
}
...
HX_END_DEFAULT_FUNC
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,int time_ms){
	...
	HX_END_LOCAL_FUNC0((void))
            	...
            	HX_JUST_GC_STACKFRAME
	 ::haxe::Timer t =  ::haxe::Timer_obj::__alloc( HX_CTX ,time_ms);
	t->run =  ::Dynamic(new _hx_Closure_0(f,t));
	return t;
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Timer_obj,delay,return )
 ...
 ::Dynamic Timer_obj::measure( ::Dynamic f, ::Dynamic pos){
	Float t0 =  ::__time_stamp();
	 ::Dynamic r = f();
	 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
	_hx_tmp((( ::__time_stamp() - t0) + HX_("s",73,00,00,00)),pos);
	return r;
}
