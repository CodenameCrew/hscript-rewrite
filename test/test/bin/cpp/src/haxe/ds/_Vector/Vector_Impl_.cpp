...
bool Vector_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Vector_Impl__obj::get(::cpp::VirtualArray this1,int index){
	return _hx_array_unsafe_get(this1,index);
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Vector_Impl__obj,get,return )
 ...
 ::Dynamic Vector_Impl__obj::set(::cpp::VirtualArray this1,int index, ::Dynamic val){
	return this1->__unsafe_set(index,val);
}
...
void Vector_Impl__obj::fill(::cpp::VirtualArray this1, ::Dynamic value){
	int _g = 0;
	int _g1 = this1->get_length();
	while((_g < _g1)){
		_g = (_g + 1);
		this1->set((_g - 1),value);
	}
}
...
void Vector_Impl__obj::blit(::cpp::VirtualArray src,int srcPos,::cpp::VirtualArray dest,int destPos,int len){
	dest->__Field(HX_("blit",35,38,19,41),::hx::paccDynamic)(destPos,src,srcPos,len);
}
...
::cpp::VirtualArray Vector_Impl__obj::copy(::cpp::VirtualArray this1){
	::cpp::VirtualArray r = ::cpp::VirtualArray_obj::__new(this1->get_length());
	r->__Field(HX_("blit",35,38,19,41),::hx::paccDynamic)(0,this1,0,this1->get_length());
	return r;
}
...
::cpp::VirtualArray Vector_Impl__obj::map(::cpp::VirtualArray this1, ::Dynamic f){
	int length = this1->get_length();
	::cpp::VirtualArray r = ::cpp::VirtualArray_obj::__new(length);
	{
		int _g = 0;
		while((_g < length)){
			_g = (_g + 1);
			int i = (_g - 1);
			 ::Dynamic v = f(_hx_array_unsafe_get(this1,i));
			r->__unsafe_set(i,v);
		}
	}
	return r;
