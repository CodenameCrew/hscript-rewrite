...
bool StringMap_obj::remove(::String key){
	return  ::__string_hash_remove(this->h,key);
}
...
HX_DEFINE_DYNAMIC_FUNC1(StringMap_obj,remove,return )
 ...
 ::Dynamic StringMap_obj::keys(){
	...
	::Array< ::String > a =  ::__string_hash_keys(this->h);
...
HX_DEFINE_DYNAMIC_FUNC0(StringMap_obj,keys,return )
 ...
 ::Dynamic StringMap_obj::iterator(){
            	HX_JUST_GC_STACKFRAME
	::cpp::VirtualArray a =  ::__string_hash_values(this->h);
	return  ::haxe::iterators::ArrayIterator_obj::__alloc( HX_CTX ,a);
}
...
HX_DEFINE_DYNAMIC_FUNC0(StringMap_obj,keyValueIterator,return )
 ...
 ::haxe::ds::StringMap StringMap_obj::copy(){
            	HX_JUST_GC_STACKFRAME
	 ::haxe::ds::StringMap copied =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
	{
		 ::Dynamic key = this->keys();
		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::String StringMap_obj::toString(){
	return  ::__string_hash_to_string(this->h);
}
