...
void MainEvent_obj::delay( ::Dynamic t){
	Float _hx_tmp;
	if (::hx::IsNull( t )) {
		_hx_tmp = ::Math_obj::NEGATIVE_INFINITY;
	}
	else {
		_hx_tmp = ( ::__time_stamp() + t);
	}
	this->nextRun = _hx_tmp;
}
...
void MainEvent_obj::stop(){
	...
	this->f = null();
	this->nextRun = ::Math_obj::NEGATIVE_INFINITY;
	if (::hx::IsNull( this->prev )) {
		::haxe::MainLoop_obj::pending = this->next;
	}
	else {
		this->prev->next = this->next;
	}
	if (::hx::IsNotNull( this->next )) {
