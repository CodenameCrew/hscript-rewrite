...
void EntryPoint_obj::runInMainThread( ::Dynamic f){
	::sys::thread::_Thread::Thread_Impl__obj::get_events(::haxe::EntryPoint_obj::mainThread)->run(f);
}
...
void EntryPoint_obj::addThread( ::Dynamic f){
	...
	void _hx_run(){
		...
		::haxe::EntryPoint_obj::threadCount--;
		::haxe::EntryPoint_obj::mutex->release();
		::sys::thread::_Thread::Thread_Impl__obj::get_events(::haxe::EntryPoint_obj::mainThread)->runPromised( ::Dynamic(new _hx_Closure_0()));
	}
	HX_END_LOCAL_FUNC0((void))
	...
	::haxe::EntryPoint_obj::threadCount++;
	::haxe::EntryPoint_obj::mutex->release();
	::sys::thread::_Thread::Thread_Impl__obj::get_events(::haxe::EntryPoint_obj::mainThread)->promise();
	::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_1(f)),false);
}
...
{
	mainThread = ::sys::thread::_Thread::HaxeThread_obj::current();
}
{
