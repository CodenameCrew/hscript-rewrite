...
bool HashMapKeyValueIterator_obj::hasNext(){
	return ( (bool)(this->keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) );
}
...
HX_DEFINE_DYNAMIC_FUNC0(HashMapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic HashMapKeyValueIterator_obj::next(){
	 ::Dynamic key = this->keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
	 ::haxe::ds::IntMap this1 = this->map->values;
