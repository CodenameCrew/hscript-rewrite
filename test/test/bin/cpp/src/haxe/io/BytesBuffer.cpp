...
void BytesBuffer_obj::addString(::String v, ::haxe::io::Encoding encoding){
	 ::haxe::io::Bytes src = ::haxe::io::Bytes_obj::ofString(v,encoding);
	::Array< unsigned char > b2 = src->b;
	{
		int _g = 0;
		int _g1 = src->length;
...
void BytesBuffer_obj::addInt64(::cpp::Int64 v){
	this->addInt32(_hx_int64_low(v));
	this->addInt32(_hx_int64_high(v));
}
...
void BytesBuffer_obj::addFloat(Float v){
	this->addInt32(::haxe::io::FPHelper_obj::floatToI32(v));
}
...
void BytesBuffer_obj::addDouble(Float v){
	this->addInt64(::haxe::io::FPHelper_obj::doubleToI64(v));
}
...
HX_DEFINE_DYNAMIC_FUNC3(BytesBuffer_obj,addBytes,(void))
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
	 ...
	 ::haxe::io::Bytes bytes =  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,this->b->length,this->b);
	this->b = null();
	return bytes;
}
