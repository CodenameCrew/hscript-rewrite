...
Float FPHelper_obj::i32ToFloat(int i){
	return  ::__hxcpp_reinterpret_le_int32_as_float32(i);
}
...
int FPHelper_obj::floatToI32(Float f){
	return  ::__hxcpp_reinterpret_float32_as_le_int32(f);
}
...
Float FPHelper_obj::i64ToDouble(int low,int high){
	return  ::__hxcpp_reinterpret_le_int32s_as_float64(low,high);
}
...
::cpp::Int64 FPHelper_obj::doubleToI64(Float v){
	int high =  ::__hxcpp_reinterpret_float64_as_le_int32_high(v);
	return _hx_int64_make(high, ::__hxcpp_reinterpret_float64_as_le_int32_low(v));
}
