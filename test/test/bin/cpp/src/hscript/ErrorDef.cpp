...
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("ECustom",d6,fd,6f,a9),10,1)->_hx_init(0,msg);
}
...
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidClass",a6,0d,a2,82),9,1)->_hx_init(0,className);
}
...
::hscript::ErrorDef ErrorDef_obj::EInvalidOp( ::haxe::ds::Either op)
{
...
::hscript::ErrorDef ErrorDef_obj::EUnexpected( ::hscript::LToken s, ::hscript::LToken expected)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EUnexpected",76,02,98,78),1,2)->_hx_init(0,s)->_hx_init(1,expected);
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(ErrorDef_obj,EUnexpected,return)
